...
async function addBO5Prono(tomorrow, match, user, score, winnerIsFirstTeam) {
    ...
    const requestOnFirstColumn = await apiGoogle.sendProno(matchColumn, playerRow, winnerIsFirstTeam ? 3 : score, sheet);
    const requestOnSecondColumn = await apiGoogle.sendProno(matchColumn + 1, playerRow, winnerIsFirstTeam ? score : 3, sheet);
